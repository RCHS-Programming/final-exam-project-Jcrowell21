...
public class World2 extends World
{
    ...
    public void makeGround2()
    {
        for(int i = 0; i < 14; i++)
        {
            addObject( new Ground2(), 10 + 60*i, 570);
        }
        for(int i = 0; i < 14; i++)
        {
            addObject( new Ground2(), 10 + 60*i, 510);
        }
        for(int i = 0; i < 14; i++)
        {
            addObject( new Ground2(), 10 + 60*i, 270);
        }
        for(int i = 0; i < 14; i++)
        {
            addObject( new Ground2(), 10 + 60*i, 30);
        }
        for(int i = 0; i < 10; i++)
        {
